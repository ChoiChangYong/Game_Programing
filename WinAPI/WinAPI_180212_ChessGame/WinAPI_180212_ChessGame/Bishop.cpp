...
vector<POINT> Bishop::MoveRangeCheck(int map[][8], vector<POINT> moverange, int x, int y, int Param)
{
	if (Param == BLACK)
	{
...
vector<POINT> Bishop::getMoveRange(int map[][8], int Param, int x, int y)
{
	m_vecMoveable.clear();
