...
vector<POINT> Queen::MoveRangeCheck(int map[][8], vector<POINT> moverange, int x, int y, int Param)
{
	if (Param == BLACK)
	{
...
vector<POINT> Queen::getMoveRange(int map[][8], int Param, int x, int y)
{
	m_vecMoveable.clear();
